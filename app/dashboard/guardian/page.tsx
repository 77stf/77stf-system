  ...
  return (
    <div style={{ padding: '32px 28px', maxWidth: 700 }}>
      ...
      <p style={{ fontSize: 13, color: t.text.muted, margin: '0 0 32px' }}>
        AI który proponuje ulepszenia zanim klient zauważy problem
      </p>
      <div style={{
        ...
        <Shield style={{ width: 36, height: 36, color: t.text.muted, margin: '0 auto 14px' }} />
        <div style={{ fontSize: 14, fontWeight: 600, color: t.text.secondary, marginBottom: 6 }}>
          W budowie — Etap 10
        </div>
        <div style={{ fontSize: 13, color: t.text.muted }}>
          Guardian Agent 2.0: AI Judge + self-improving prompts + raporty per klient.
        </div>
      </div>
    </div>
  )
